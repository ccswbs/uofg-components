...
export function DismissibleAlert({ title, description, timestamp, link }: DismissibleAlertProps) {
  ...
  return (
    <button
      ...
      className="fixed top-1.5 left-1.5 z-10000 flex cursor-pointer items-center justify-center gap-[0.25em] bg-red p-2 text-red-contrast shadow-md transition hover:bg-black hover:text-white focus:bg-black focus:text-white"
    >
