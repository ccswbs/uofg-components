...
export function TextInput({
  ...
  const textInput = tv({
    slots: {
      ...
      wrapper:
        'uog:text-input uog:border-light-grey uog:flex uog:rounded-md uog:border uog:px-4 uog:py-2 uog:transition-colors uog:focus-within:border-blue uog:focus:outline-none',
